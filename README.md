...
O projeto representa o MVP de uma plataforma de games educacionais (FCG), com foco no gerenciamento de usuários e seus jogos adquiridos.
...
🧱 Arquitetura
O projeto segue uma separação clara de responsabilidades, inspirada em princípios de Clean Architecture.
Camadas principais
...
Infrastructure
Repositórios, acesso a dados e persistência com Entity Framework Core
